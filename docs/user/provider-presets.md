...
Presets save the documented route set when you create or explicitly reapply one. They never derive replacement paths from a runtime hostname and never rewrite an already saved connection. OpenAI/Azure/Bedrock retain Responses, Anthropic retains Messages, and other presets retain their documented supported formats. Gemini's native Google API is outside these three upstream formats, so its preset uses the documented OpenAI-compatible surface.
...
| MiniMax API (CN) | Chat Completions + Responses + Messages | Bearer (Chat/Responses); `x-api-key` (Messages) | [API docs](https://platform.minimax.cn/docs/api-reference/responses-create) | [`MiniMax-M2.5`](https://platform.minimax.cn/docs/api-reference/responses-create) |
| MiniMax API / Token Plan (Global) | Chat Completions + Responses + Messages | Bearer (Chat/Responses); `x-api-key` (Messages) | [API docs](https://platform.minimax.io/docs/api-reference/responses-create) | [`MiniMax-M3`](https://platform.minimax.io/docs/api-reference/responses-create) |
...
| Xiaomi MiMo API | Chat Completions + Responses + Messages | bearer | [API docs](https://mimo.mi.com/docs/en-US/tokenplan/integration/codex-configuration) | [`mimo-v2.6-flash`](https://mimo.mi.com/docs/en-US/tokenplan/integration/codex-configuration) |
| Xiaomi MiMo Token Plan (CN) | Chat Completions + Responses + Messages | bearer | [API docs](https://mimo.mi.com/docs/en-US/tokenplan/integration/claudecode) | [`mimo-v2.6-flash`](https://mimo.mi.com/docs/en-US/tokenplan/integration/codex-configuration) |

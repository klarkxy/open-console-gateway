...
ADDED = {
    ...
    "scripts/repair-integration-v2.4.2.py",
    "crates/ocg-core/tests/dashboard_v3_observability.rs",
    "crates/ocg-core/tests/dashboard_v3_provider_probes.rs",
    "crates/ocg-core/tests/dashboard_v3_providers.rs",
    "crates/ocg-core/tests/gateway_fallback.rs",
    "crates/ocg-core/tests/fixtures/gateway_fallback.rs",
